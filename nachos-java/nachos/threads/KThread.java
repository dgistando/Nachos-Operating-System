...
public class KThread {
     ...
     * delete this thread.
     */
	public static void finish() {//just change this
    ...
    public void join() {
		...
		//Make sure not current thread
		if(this != currentThread){
			waitQueue.waitForAccess(currentThread);
			currentThread.sleep();
		}

		//System.out.println("Join didn't work on thread "+ this);
		Machine.interrupt().restore(interrupt);
     ...
     */
     //* @param	<tt>true</tt> if the current thread is
    ...
    private static ThreadQueue readyQueue = null, waitQueue = null;
